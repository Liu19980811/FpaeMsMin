...
const pages = [
  ...
  {
    path: "pages/tabBar/homepage/more-product",
    style: {
  ...
  {
    path: "pages/device-details/device-details",
    style: {
      navigationBarTitleText: "投料机详情",
      navigationBarTextStyle: "black",
  ...
  {
    path: "pages/my-ponds/my-ponds",
    style: {
      navigationBarTitleText: "我的鱼塘",
      navigationBarTextStyle: "black",
      navigationBarBackgroundColor: "#FFF",
      enablePullDownRefresh: true
    }
  ...
  {
    path: "pages/warn-info/warn-info",
    style: {
  ...
  list: [
    {
      ...
      selectedIconPath: "static/image/tabBar/homepage-sel.png",
      text: "首页"
    },
    {
      pagePath: "pages/tabBar/device/device",
    ...
    },
    {
      ...
      selectedIconPath: "static/image/tabBar/mine-sel.png",
      text: "我的"
    }
  ]
};
...
const S$1 = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = b, T = I(""), C = I("[]") || [];
let O = "";
try {
  O = "__UNI__B8A034E";
} catch (e2) {
...
class Gn {
  ...
  _send(e2, t2) {
    ...
    if (s2.$db.push({ $method: e2, $param: zn(t2) }), S$1) {
    ...
    s2 && function(e3 = {}) {
      ...
      Z().then(() => {
        ...
        if (n3 && _s({ redirect: n3 }))
          return t3.length > 0 ? Y$1($, Object.assign({ uniIdRedirectUrl: n3 }, e3)) : void (hs && ws({ api: "navigateTo", redirect: n3 }));
      });
    }(n2);
  });
}
function bs(e2) {
  !function(e3) {
    ...
    e3.onNeedLogin = function(e4) {
      ...
      V($, e4);
    }, us && (L$1("_globalUniCloudStatus").needLoginInit || (L$1("_globalUniCloudStatus").needLoginInit = true, Z().then(() => {
      Is.call(e3);
    }), ds && Ss.call(e3)));
  }(e2), function(e3) {
  ...
  return function(t2, n2 = {}) {
    ...
    return new Proxy({}, { get(s3, c2) {
      ...
      return function({ fn: e3, interceptorName: t3, getCallbackArgs: n3 } = {}) {
        ...
        if (a2 && index.hideLoading(), y2 && y2.token && y2.tokenExpired && (ie(y2), Y$1(B, { ...y2 })), g2) {
          let e3 = m2;
          if (p2 && o2) {
  ...
  init(e2) {
    ...
    t2 = n2.init(e2), function(e3) {
      ...
      e3.getCurrentUserInfo = Ts, e3.chooseAndUploadFile = xs.initChooseAndUploadFile(e3), Object.assign(e3, { get mixinDatacom() {
        return Es(e3);
      } }), e3.SSEChannel = qs, e3.initSecureNetworkByWeixin = Ds(e3), e3.importObject = Ls$1(e3);
    }(t2);
...
(() => {
  ...
  Object.assign(Bs, { get mixinDatacom() {
    return Es(Bs);
  } }), bs(Bs), Bs.addInterceptor = N, Bs.removeInterceptor = D$1, Bs.interceptObject = F;
})();
var Ws = Bs;
