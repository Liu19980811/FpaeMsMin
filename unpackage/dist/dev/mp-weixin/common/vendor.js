...
const pages = [
  ...
  {
    path: "pages/warn-records/warn-records",
    style: {
  ...
  {
    path: "pages/warn-records/single-dev-warn",
    style: {
      navigationBarTitleText: "投料机001报警记录",
      navigationBarTextStyle: "black",
      navigationBarBackgroundColor: "#FFF",
      enablePullDownRefresh: true
    }
...
const S$1 = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I(""), T = I("[]") || [];
let O = "";
try {
  O = "__UNI__B8A034E";
} catch (e2) {
